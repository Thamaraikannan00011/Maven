...
***Pre-clean*** - It executes before the clean phase. it perform any clean performance needed.

***clean*** - delete the project build directory/folder. removes all files generated by previous build.
